...
import { Passcode, PasswordWithHelper, Button } from '@ui/ui'
  ...
  return (
    <>
      ...
      <Form layout="vertical">
        <Form.Item>
          <h2>Passcode</h2>
          <span>Your 4-digit code used to access ui Go (for iPad/iPhone)</span>
          <br />
          <br />
          <Passcode />
        </Form.Item>
      ...
      <Form layout="vertical">
        <Form.Item>
          ...
          <span>
            Two factor authentication adds an extra layer of security to your ui
            account.
          </span>
          <br />
          <span>Details</span>
