...
import { BasicModal as Modal, ButtonTypes } from '@ui/ui'
...
export const LeadIntegration: React.FC = () => {
  ...
  const [openuiLeadModal, setuiLeadModal] = useState(false)
  ...
  return (
    <>
      ...
      <Modal
        ...
        closable={true}
        onCancel={() => setuiLeadModal((e) => !e)}
        visible={openuiLeadModal}
        title={'ui Leads'}
        newButtonText={'Close'}
      ...
      >
        <p>
          ...
          follow this guide on how to implement ui Leads.
        </p>
      </Modal>
