...
import { Webinar, Button, WebinarModal, WebinarModalProps } from '@ui/ui'
...
const data = [
  {
    ...
    isJoin: true,
    description:
      'This training session is to kick start your ui journey, suitable for anyone starting off with the system, fron desh, practioers and anyone who nneds to know how to book. It covers all the core features you will need on a daily basisss, to ensure you are able to work at ease with the system.',
  },
  {
    id: '2',
