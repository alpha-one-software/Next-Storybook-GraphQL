...
import { ReactComponent as uiLOGO } from '../../assets/images/uilogo.svg'
    ...
    <Menu className={styles.avatarMenu}>
      ...
      >
        <div className={styles.dropdownHeader}>
          <uiLOGO />
          <span className={styles.headerText}>ui Clinic Software</span>
        </div>
      ...
      <Menu key="3" className={styles.avatarHelpMenu}>
        ...
        <Menu.Item className={styles.avatarHelpSubList}>
          <div className={styles.feedbackAlignContent}>
            ...
            <span className="">Help us improve ui</span>
          </div>
        </Menu.Item>
        <Menu.Item className={styles.avatarHelpSubList}>
          <div className={styles.feedbackAlignContent}>
