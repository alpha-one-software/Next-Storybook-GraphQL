...
import { Button, WebinarModal, WebinarModalProps } from '@ui/ui'
...
export const Webinar: FC = () => {
  ...
  const handleOpenModal = () => {
    const selectedData: WebinarModalProps = {
      ...
      timeLeft: '18:28',
      description:
        'This training session is to kick start your ui jorney, suitable for anyone starting off with the system, fron desh, practioers and anyone who nneds to know how to book. It covers all the core features you will need on a daily basisss, to ensure you are able to work at ease with the system.',
