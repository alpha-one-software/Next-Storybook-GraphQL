...
export const uiHeaderStory = (): JSX.Element => {
  return <Header searchRender={() => uiSearch()} />
}

export const uiLogo = (): JSX.Element => {
  return <Logo />
}

export const uiSearch = (): JSX.Element => {
